...
CREATE TABLE bancos(
	...
	_fecha_inser TIMESTAMP NOT NULL,
     _fecha_modif TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
     _usuario INT NOT NULL,
     _estado CHAR(1) NOT NULL,
	PRIMARY KEY(id_banco)
)ENGINE=INNODB;

INSERT INTO bancos VALUES (1, 'banco Union', 'b. constructor', '654789', 'bancounion.com', now(), now(), '1', '1');

CREATE TABLE b_clientes(
	id_cliente INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO b_clientes VALUES ('1', '1', '123123123', 'alex', 'cardozo', 'isurza', 'C/ Camargo', '6549873', now(), now(), '1', '1')
