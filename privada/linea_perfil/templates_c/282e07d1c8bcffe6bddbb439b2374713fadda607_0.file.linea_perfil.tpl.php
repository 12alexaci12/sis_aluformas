<?php
/* Smarty version 3.1.29, created on 2020-10-01 21:33:01
  from "D:\disenoWeb\www\sis_aluformas\privada\linea_perfil\templates\linea_perfil.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5f764b0d2f2f82_86088312',
  'file_dependency' => 
  array (
    '282e07d1c8bcffe6bddbb439b2374713fadda607' => 
    array (
      0 => 'D:\\disenoWeb\\www\\sis_aluformas\\privada\\linea_perfil\\templates\\linea_perfil.tpl',
      1 => 1601587950,
      2 => 'file',
    ),
  ),
...
function content_5f764b0d2f2f82_86088312 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
?>
				<tr>
                    ...
                    <td>
						<form name="formModif<?php echo $_smarty_tpl->tpl_vars['r']->value['id_linea_perfil'];?>
" method="post" action="linea_perfil_modificar.php">
						<input type="hidden" name="id_linea_perfil" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['id_linea_perfil'];?>
">
						<a href="javascript:document.formModif<?php echo $_smarty_tpl->tpl_vars['r']->value['id_linea_perfil'];?>
.submit();" title="Modificar linea_perfil Sistema">
							Modificar>>>
						</a>
						</form>
					</td>
					<td>
						<form name="formElimi<?php echo $_smarty_tpl->tpl_vars['r']->value['id_linea_perfil'];?>
" method="post" action="linea_perfil_eliminar.php">
						<input type="hidden" name="id_linea_perfil" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['id_linea_perfil'];?>
">
						<a href="javascript:document.formElimi<?php echo $_smarty_tpl->tpl_vars['r']->value['id_linea_perfil'];?>
.submit();" title="Eliminar linea_perfil Sistema" onclick='javascript: return(confirm("Desea realmente Eliminar al linea_perfil..?"));'>
							Eliminar>>>
						</a>
						</form>
					</td>
...
?>
	                                    ...
	                                    <b style="linea_perfil:#fb992f; font-size:16px;"> <?php echo $_smarty_tpl->tpl_vars['pag']->value['npag'];?>
</b>
	                                    <?php } else { ?>
