<?php
/* Smarty version 3.1.29, created on 2020-10-01 21:38:58
  from "D:\disenoWeb\www\sis_aluformas\privada\tipo_vidrio\templates\tipo_vidrio.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5f764c7206e027_78243494',
  'file_dependency' => 
  array (
    '8d7b4020cf0b3209ff1ab433044babc10c09209e' => 
    array (
      0 => 'D:\\disenoWeb\\www\\sis_aluformas\\privada\\tipo_vidrio\\templates\\tipo_vidrio.tpl',
      1 => 1601588289,
      2 => 'file',
    ),
  ),
...
function content_5f764c7206e027_78243494 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, "b", 0);?>
	               <?php
$_from = $_smarty_tpl->tpl_vars['tipo_vidrio']->value;
...
?>
				<tr>
                    ...
                    <td>
						<form name="formModif<?php echo $_smarty_tpl->tpl_vars['r']->value['id_tipo_vidrio'];?>
" method="post" action="tipo_vidrio_modificar.php">
						<input type="hidden" name="id_tipo_vidrio" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['id_tipo_vidrio'];?>
">
						<a href="javascript:document.formModif<?php echo $_smarty_tpl->tpl_vars['r']->value['id_tipo_vidrio'];?>
.submit();" title="Modificar tipo_vidrio Sistema">
							Modificar>>>
						</a>
						</form>
					</td>
					<td>
						<form name="formElimi<?php echo $_smarty_tpl->tpl_vars['r']->value['id_tipo_vidrio'];?>
" method="post" action="tipo_vidrio_eliminar.php">
						<input type="hidden" name="id_tipo_vidrio" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['id_tipo_vidrio'];?>
">
						<a href="javascript:document.formElimi<?php echo $_smarty_tpl->tpl_vars['r']->value['id_tipo_vidrio'];?>
.submit();" title="Eliminar tipo_vidrio Sistema" onclick='javascript: return(confirm("Desea realmente Eliminar al tipo_vidrio..?"));'>
							Eliminar>>>
						</a>
						</form>
					</td>
...
?>
	                                    ...
	                                    <b style="tipo_vidrio:#fb992f; font-size:16px;"> <?php echo $_smarty_tpl->tpl_vars['pag']->value['npag'];?>
</b>
	                                    <?php } else { ?>
